...
class cafe_management():
        ...
        def __init__(self):
                ...
                self.cafe_icon = ImageTk.PhotoImage(Image.open(r'C:\Users\jebin\OneDrive\Documents\VSCode Projects\1.2 Python Projects\cafe.png'))
                ...
                self.icon = ImageTk.PhotoImage(Image.open(r'C:\Users\jebin\OneDrive\Documents\VSCode Projects\1.2 Python Projects\false.png'))
